...
<body>
  ...
  <div class="topnav2">
   <h1 style="color: aqua;">The BMW-3series{INR 66.25 - 69.20 Lakh* }</h1>
    </div>
...
<div class="mySlides fade">
  ...
  <img src="images/bmw3series1.jpg" style="width: 100%;">
  <div class="text">The BMW</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 4</div>
  <img src="images/bmw3series2.jpg" style="width: 100%;">
  <div class="text">Best Features</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 4</div>
  <img src="images/bmw3series3.jpg" style="width: 100%;">
  <div class="text">Cool Interior</div>
</div>

<div class="mySlides fade">
    <div class="numbertext">4 / 4</div>
    <img src="images/3-series-interior-steering-wheel.jpeg" style="width: 100%;">
...
<br><div class="header">
  <h6>The BMW 3 Series is a line of compact executive cars manufactured by the German automaker BMW since May 1975. It is the successor to the 02 Series and has been produced in seven generations.
...
The 3 Series is BMW's best-selling model, accounting for around 30% of the BMW brand's annual total sales (excluding motorbikes),[1] and has won numerous awards throughout its history.

The M version of the 3 series, M3, debuted with the E30 M3 in 1986.[2]The M3 is the most powerful version of the 3 Series. It was designed and developed by BMW's in-house motorsport division, BMW M.
...
The last M3 coupe was produced in Germany on 5 July 2013, replaced by the F82/F83 M4 Coupe and convertible starting with the 2015 model year,[18][19] but the M3 name remains in use for the sedan version. The new generation M3 was reintroduced in 2021, codenamed G80 from the 7th generation 3 Series (G20). The M3 represented above (The F80) was powered by a BMW N55 engine producing 431 horsepower and 7,600 RPM.[20]

In June 2022, BMW revealed the first BMW M3 Touring, codenamed G81. Based on the seventh generation 3 Series, it marks the first time a BMW M Touring model reached the market.[21] The touring version of the M3 contains the same engine and interior setup as the M3 sedan, but extends the roof line to become a wagon.[22]</h6>
</div><br>
<script>
let slideIndex = 1;
