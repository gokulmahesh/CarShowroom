...
<body>
  ...
  <div class="topnav2">
   <h1 style="color: aqua;">Audi A8 L{INR 1.34 - 1.63 Cr*}</h1>
    </div>
...
<div class="mySlides fade">
  ...
  <img src="images/audi_a81.webp" style="width: 100%;">
  <div class="text">Best features</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 4</div>
  <img src="images/audi_a82.jpg" style="width: 100%;">
  <div class="text">Good performance</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 4</div>
  <img src="images/audi_a8in.jpeg" style="width: 100%;">
  <div class="text">Cool Interior</div>
</div>

<div class="mySlides fade">
    <div class="numbertext">4 / 4</div>
    <img src="images/audi_a83.jpeg" style="width: 100%;">
...
<br><div class="header">
  <h6>The Audi A8 is a full-size luxury sedan manufactured and marketed by the German automaker Audi since 1994. Succeeding the Audi V8, and now in its fourth generation, the A8 has been offered with both front- or permanent all-wheel drive—and in short- and long-wheelbase variants. The first two generations employed the Volkswagen Group D platform, with the current generation deriving from the MLB platform. After the original model's 1994 release, Audi released the second generation in late 2002, the third in late 2009, and the fourth and current iteration in 2017.

Noted as the first mass-market car with an aluminium chassis, all A8 models have used this construction method co-developed with Alcoa and marketed as the Audi Space Frame.[2]

A mechanically upgraded, high-performance version of the A8 debuted in 1996 as the Audi S8. Produced exclusively at Audi's Neckarsulm plant, the S8 is fitted standard with Audi's quattro all-wheel drive system. The S8 was only offered with a short-wheelbase for the first three generations, being joined by a long-wheelbase variant for the fourth generation.[3]</h6>
