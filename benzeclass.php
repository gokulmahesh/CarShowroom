...
<body>
  ...
  <div class="topnav2">
   <h1 style="color: aqua;">Mercedes Benz E Class {INR 70 -72.42 Lakh*}</h1>
    </div>
...
<div class="mySlides fade">
  ...
  <img src="images/benzeclass1.jpeg" style="width: 100%;">
  <div class="text">Classic </div>
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 4</div>
  <img src="images/benzeclass2.jpg" style="width: 100%;">
  <div class="text">Awesome</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 4</div>
  <img src="images/benzeclassin.jpg" style="width: 100%;">
  <div class="text">COOL Interior</div>
</div>

<div class="mySlides fade">
    <div class="numbertext">4 / 4</div>
    <img src="images/benzeclass3.jpg" style="width: 100%;">
...
<br><div class="header">
  <h6>The Mercedes-Benz E-Class is a range of executive cars manufactured by German automaker Mercedes-Benz in various engine and body configurations. Produced since 1953, the E-Class falls midrange in the Mercedes line-up, and has been marketed worldwide across five generations.
...
Historically, the E-Class is Mercedes-Benz' best-selling model, with more than 13 million sold by 2015.[1] The first E-Class series was originally available as four-door sedan, five-door station wagon, 2 door coupe and 2 door convertible. From 1997 to 2009, the equivalent coupe and convertible were sold under the Mercedes-Benz CLK-Class nameplate; which was actually based on the mechanical underpinnings of the smaller C-Class while borrowing the styling and some powertrains from the E-Class, a trend continued with the C207 E-Class coupe/convertible which was sold parallel to the W212 E-Class sedan/wagon. With the latest incarnation of the E-Class released for the 2017 model year, all body styles share the same W213 platform.[2]</h6>
</div><br>
<script>
let slideIndex = 1;
