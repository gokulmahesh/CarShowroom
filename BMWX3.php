...
<body>
  ...
  <div class="topnav2">
   <h1 style="color: aqua;">BMW X3 {INR 61.90 - 67.90 Lakh*}</h1>
    </div>
...
<div class="mySlides fade">
  ...
  <img src="images/bmwx3_1.jpeg" style="width: 100%;">
  <div class="text">Better performance</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 4</div>
  <img src="images/bmw-x3-m-competition-exterior-3.jpg" style="width: 100%;">
  <div class="text">Classic </div>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 4</div>
  <img src="images/bmwx3_3.jpg.crdownload" style="width: 100%;">
  <div class="text">Good Interior</div>
</div>

<div class="mySlides fade">
    <div class="numbertext">4 / 4</div>
    <img src="images/bmwx3_in.jpg" style="width: 100%;">
    <div class="text">Good Engine</div>
  </div>
...
<br><div class="header">
  <h6>The BMW X3 is a compact luxury crossover SUV manufactured by BMW since 2003, based on the BMW 3 Series platform. Now in its third generation, BMW markets the car as a Sports Activity Vehicle, the company's proprietary descriptor for its X-line luxury vehicles.
...
An all-electric variant is sold as the BMW iX3.</h6>
</div><br>
<script>
let slideIndex = 1;
